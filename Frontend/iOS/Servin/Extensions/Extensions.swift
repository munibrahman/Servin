...
extension UIViewController  {
    ...
    func showAlertController(title: String?, subtitle: String?) {
        DispatchQueue.main.async {
            let alertViewController = UIAlertController.init(title: title, message: subtitle, preferredStyle: UIAlertController.Style.alert)
            
            let ok = UIAlertAction.init(title: "Ok", style: UIAlertAction.Style.default, handler: { (action) in
...
extension UICollectionView {
    ...
    func setEmptyMessage(_ message: String, image: UIImage?) {
        ...
        messageLabel.textColor = UIColor.blackFontColor
        ...
        messageLabel.bottomAnchor.constraint(equalTo: imageView.topAnchor, constant: -5).isActive = true
...
//            
//            let leftBarItem = UIBarButtonItem.init(image: #imageLiteral(resourceName: "x_black"), style: .plain, target: self, action: #selector(userDidPressX))
