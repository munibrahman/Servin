...
public final class CreateConversationMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateConversation: GraphQLSelectionSet {
      ...
      public init(createdAt: String? = nil, id: GraphQLID, discoveryId: String, messages: Message? = nil) {
        self.init(snapshot: ["__typename": "Conversation", "createdAt": createdAt, "id": id, "discoveryId": discoveryId, "messages": messages.flatMap { $0.snapshot }])
      }
    ...
    public struct CreateUserConversation: GraphQLSelectionSet {
      ...
      public struct Associated: GraphQLSelectionSet {
        ...
        public struct Conversation: GraphQLSelectionSet {
          ...
          public init(createdAt: String? = nil, id: GraphQLID, discoveryId: String) {
        ...
        public struct User: GraphQLSelectionSet {
          ...
          public init(userId: GraphQLID, username: String, registered: Bool? = nil) {
            self.init(snapshot: ["__typename": "User", "userId": userId, "username": username, "registered": registered])
          }
