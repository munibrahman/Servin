...
exports.lambdaHandler = (event, context, callback) => {
    ...
    const account_token = event.arguments.arguments.account_token;
    ...
    .then((data) => {
        ...
        return stripe.accounts.update(data.Item.stripe_account_id, stripeParams);
    })
    .catch((err) => {
        console.log("Error updating stripe account");
        console.log(JSON.stringify(err));
        callback(err);
        return Promise.reject(err);
    }).then((data) => {
