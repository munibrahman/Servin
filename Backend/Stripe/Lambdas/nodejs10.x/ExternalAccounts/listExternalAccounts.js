...
exports.lambdaHandler = (event, context, callback) => {
    ...
    const { type, limit, ending_before, starting_after } = event.arguments.arguments;
    ...
    .then((data) => {
        ...
        // If there parameters are undefined, the stripe api ignores them.
        const stripeParams = {
            object : type,
            limit: limit,
        ...
        // Calling stripe to get external accounts
        return stripe.accounts.listExternalAccounts(data.Item.stripe_account_id, stripeParams);
    })
    .catch((err) => {
