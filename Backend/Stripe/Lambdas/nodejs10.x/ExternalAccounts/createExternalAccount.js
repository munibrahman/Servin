...
// Sample event:
// {
//     "field": "createExternalAccount",
//     "arguments": {
//         "arguments": {
//             "external_account_token": "ba_1EkakhKcsHuVb8KD3LieY824"
//         },
//         "identity": {
...
exports.lambdaHandler = (event, context, callback) => {
    ...
    const { username, sourceIp } = event.arguments.identity;
    const { event_id } = event.arguments.identity.claims;
    const { field } = event;
    const external_account_token = event.arguments.arguments.external_account_token;
    ...
    .then((data) => {
        ...
        return stripe.accounts.createExternalAccount(data.Item.stripe_account_id, stripeParams);
    })
    .catch((err) => {
